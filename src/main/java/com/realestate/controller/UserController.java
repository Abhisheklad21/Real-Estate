...
public class UserController {
    ...
    //http://localhost:8080/api/user/login?email=&password=
//    @PostMapping("/login")
//    public Map<String, String> loginUser(@RequestParam String email, @RequestParam String password) {
//        Map<String, String> status = userService.loginUser(email, password);
//    return status;
//    }
}
